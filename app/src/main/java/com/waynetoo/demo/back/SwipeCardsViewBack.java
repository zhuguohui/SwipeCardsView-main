package com.waynetoo.demo.back;
...
public class SwipeCardsViewBack extends LinearLayout {
    ...
    public SwipeCardsViewBack(Context context) {
        this(context, null);
    }

    public SwipeCardsViewBack(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeCardsViewBack(Context context, AttributeSet attrs, int defStyle) {
...
//        Log.i(TAG, "ajustLinkageViewItem: rate=" + rate + "  alpha=" + v);
     ...
     *
     * @param type {@link SwipeCardsViewBack.SlideType}
     */
